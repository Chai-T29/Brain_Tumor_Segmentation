...
from dqn.model import QNetwork, DuelingQNetwork, DuelingQNetworkSmall, DuelingQNetworkHF
...
class DQNLightning(pl.LightningModule):
    ...
    def __init__(
        ...
        self.policy_net = DuelingQNetworkSmall(num_actions=9)
        self.target_net = DuelingQNetworkSmall(num_actions=9)
